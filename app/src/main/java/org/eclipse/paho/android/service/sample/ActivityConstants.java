...
public class ActivityConstants {
  ...
  static final int defaultPort = 1883;
    /** Deafault QOS values for predefined subscription topics */
    static final int defaultMessageQOS = 0;
    static final int defaultAlarmQOS = 1;
    static final int defaultStatusQOS = 1;
    /** max num of visualized history elements */
    static final int maxHistoryElements = 20;
  ...
  static final String action = "action";
    /** Message Topic Subscription Bundle Key **/
    static final String subscribeMessageFlag = "subscribeMessageFlag";
    /** AlarmTopic Topic Subscription Bundle Key **/
    static final String subscribeAlarmFlag = "subscribeAlarmFlag";
    /** AlarmTopic Topic Subscription Bundle Key **/
    static final String subscribeStatusFlag = "subscribeStatusFlag";
