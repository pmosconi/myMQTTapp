...
public class Connection {
   ...
   */
    ...
    /**
     * The deviceName associated with the connection *
     */
    ...
    /**
     * Subscription topic flags *
     */
    private boolean subscribeMessage = true;
    private boolean subscribeAlarm = true;
     ...
     * @param deviceName    the name of the device the connection points to
     * @return a new instance of <code>Connection</code>
     */
    public static Connection createConnection(String clientId, String host,
                                              int port, Context context, boolean sslConnection, String deviceName,
                                              boolean subscribeMessage, boolean subscribeAlarm, boolean subscribeStatus) {
        String handle = null;
        String uri = null;
        if (sslConnection) {
            uri = "ssl://" + host + ":" + port;
        ...
        return new Connection(handle, clientId, host, port, context, client, sslConnection, deviceName,
                subscribeMessage, subscribeAlarm, subscribeStatus);
    ...
    public Connection(String clientHandle, String clientId, String host,
                      int port, Context context, MqttAndroidClient client, boolean sslConnection, String deviceName,
                      boolean subscribeMessage, boolean subscribeAlarm, boolean subscribeStatus) {
...
//    sb.append(clientId);
 ...
 //       Bundle data = new Bundle();
        ...
        // display at most a predefined number of elements from the most recent backwords
  //      int maxHistoryElements = ( (Integer) data.get(ActivityConstants.maxHistoryElements));
        int maxHistoryElements = 20;
        i = (history.size() -1) < maxHistoryElements ? i : maxHistoryElements;
    ...
    /**
     * Get the device name for the connection that this connection object is associated with
     *
     * @return the device name of the server this connection object is associated with
     */
    ...
    /**
     * Determines if topics are subscribed, returning a C style integer value
     *
     * @return 1 if subscribed  0 if not
     */
    public int isMessageSubscribed() {
        return subscribeMessage ? 1 : 0;
    }

    public int isAlarmSubscribed() {
        return subscribeAlarm ? 1 : 0;
    }

    public int isStatusSubscribed() {
 ...
 *
 * @param "true" if subscribed  "false" if not
 */
    public void setSubscribeMessage(boolean subscription) {subscribeMessage = subscription; }

    public void setSubscribeAlarm(boolean subscription) {subscribeAlarm = subscription; }

    public void setSubscribeStatus(boolean subscription) {subscribeStatus = subscription; }
