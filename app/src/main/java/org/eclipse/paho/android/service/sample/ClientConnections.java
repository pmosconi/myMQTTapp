...
public class ClientConnections extends ListActivity {
  ...
  private void connectAction(Bundle data) {
    ...
    String deviceName = (String) data.get(ActivityConstants.deviceName);
    ...
    //Topic subscriptions
    boolean subscribeMessage = false;
    boolean subscribeAlarm = false;
    ...
    Connection connection = new Connection(clientHandle, clientId, server, port,
        this, client, ssl, deviceName, subscribeMessage, subscribeAlarm, subscribeStatus);
